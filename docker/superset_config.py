...
print(f"EXAMPLES_USER: {EXAMPLES_USER}")
print(f"EXAMPLES_HOST: {EXAMPLES_HOST}")
print(f"EXAMPLES_DB: {EXAMPLES_DB}")
...
print(f"SQLALCHEMY_EXAMPLES_URI: {SQLALCHEMY_EXAMPLES_URI}")
